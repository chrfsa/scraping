...
try:
    ...
    # Extraire les liens des cours de la sous-catégorie
    courses = driver.find_elements(By.CLASS_NAME, "ais-infinite-hits--item")
    course_links = [course.find_element(By.TAG_NAME, "a").get_attribute("href") for course in courses]
    ...
    for course_link in course_links:
        ...
        courses_data.append([category_title, "Gestion d'entreprise", course_name, duration, rating, intervenant, editor_text])
